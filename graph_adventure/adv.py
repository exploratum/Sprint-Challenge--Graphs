...
while len(traversalGraph) != len(roomGraph):
    ...
    # otherwise find closest unexplored room
        ...
        # if there is only one value in the path to closest unexplored room it means the 
        # player has not moved
        # Previously explored room, now closest neighbor has some unexplored exits 
        # there will be no need to process the path
        if len(path_to_closest_unexplored) != 1:
